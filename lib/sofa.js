...
(function () {
    ...
    sofa.createdb = function (callback) {

        // Creates configured DB.
    ...
    sofa.destroydb = function (callback) {

        // Destroys configured database
    ...
    sofa.deleteDocument = function (id, revid, callback) {

        var DeleteDocument = function (docid, docRevID) {
            ...
            return new Promise( function (resolve, reject) {
                ...
                db.destroy(docid, docRevID, function (err, body) {
    ...
    sofa.insertID = function (doc, name, callback) {
        ...
        // Inserts with supplied id rather than automatic id generation.
        // Function assumes user session already exists.

        var InsertID = function (document, suppliedid) {
    ...
    sofa.view = function (design, viewname, params, callback ) {
        ...
        var DesignView = function (idesign, iviewname, iparams) {
            ...
            return new Promise( function (resolve, reject) {
                ...
                db.view(idesign, iviewname, iparams, function (err, body, headers) {
